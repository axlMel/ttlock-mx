...
// import 'package:api_app/screens/icards/created_iccard_screen.dart';
import 'package:api_app/widgets/loading_overlay.dart';
import 'package:api_app/helpers/error_helper.dart';


class NewIccardScreen extends StatefulWidget {
  final EKey keyData;
  final LockCommunicationMode communicationMode;

  const NewIccardScreen({super.key, required this.communicationMode, required this.keyData});
  
  @override
  State<NewIccardScreen> createState() => _NewIccardScreenState();
}

class _NewIccardScreenState extends State<NewIccardScreen>{
  final wifiService = WifiIccardService();
  ...
  Widget build(BuildContext context) {
    return LoadingOverlay(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 148, 157, 163),
